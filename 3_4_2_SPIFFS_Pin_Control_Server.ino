...
void setup(){
  ...
  wifiMulti.addAP("iphone", "12345678"); // 将需要连接的一系列WiFi ID和密码输入这里
...
void handleLEDControl(){
   bool ledStatus = digitalRead(D2);     // 此变量用于储存LED状态     
   ledStatus == HIGH ? digitalWrite(D2, LOW) : digitalWrite(D2, HIGH);  // 点亮或者熄灭LED  
